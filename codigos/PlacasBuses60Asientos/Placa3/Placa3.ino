...
const int N = 8;
int asientos[] = { 33, 34, 37, 38, 41, 42, 45, 46 };
...
void loop() {
  ...
  asiento33 = digitalRead(sensor0);
  asiento34 = digitalRead(sensor2);
  asiento37 = digitalRead(sensor3);
  asiento38 = digitalRead(sensor4);
  asiento41 = digitalRead(sensor5);
  asiento42 = digitalRead(sensor6);
  asiento45 = digitalRead(sensor7);
  asiento46 = digitalRead(sensor8);


  if (asiento33 == HIGH) {  //valida que el sensor no detecte nada y guarda el numero del asiento
    asientos[0] = 33;

...
const int N = 8;
int asientos[] = { 1, 2, 5, 6, 9, 10, 11, 12, 13 };
...
void loop() {
  ...
  asiento5 = digitalRead(sensor3);
  asiento6 = digitalRead(sensor4);
  asiento9 = digitalRead(sensor5);
  asiento10 = digitalRead(sensor6);
  asiento11 = digitalRead(sensor7);
  asiento12 = digitalRead(sensor8);
  asiento13 = digitalRead(sensor9);

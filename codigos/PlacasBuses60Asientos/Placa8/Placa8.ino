...
const int N = 8;
int asientos[] = { 51, 54, 57, 60 };

// inicialzando los pines en alto
int asiento51 = HIGH;   //Asiento disponible
int asiento54 = HIGH;   //Asiento disponible
int asiento57 = HIGH;   //Asiento disponible
int asiento60 = HIGH;   //Asiento disponible
...
void loop() {
  ...
  asiento51 = digitalRead(sensor0);
  asiento54 = digitalRead(sensor2);
  asiento57 = digitalRead(sensor3);
  asiento60 = digitalRead(sensor4);



  if (asiento51 == HIGH) {  //valida que el sensor no detecte nada y guarda el numero del asiento
    asientos[0] = 51;

...
const int N = 8;
int asientos[] = { 11, 12, 14, 15, 17, 18, 20, 21 };
...
void loop() {
  ...
  asiento11 = digitalRead(sensor0);
  asiento12 = digitalRead(sensor2);
  asiento14 = digitalRead(sensor3);
  asiento15 = digitalRead(sensor4);
  asiento17 = digitalRead(sensor5);
  asiento18 = digitalRead(sensor6);
  asiento20 = digitalRead(sensor7);
  asiento21 = digitalRead(sensor8);
 


  if (asiento11 == HIGH) {  //valida que el sensor no detecte nada y guarda el numero del asiento
    asientos[0] = 11;
